...
const contactInfo = [];
graduates.filter(function(info){
...
*/
const displayNames = [];
zooAnimals.forEach(list => displayNames.push(`Name: ${list.animal_name}, Scientific: ${list.scientific_name}`));
...
*/
const populationTotal = zooAnimals.reduce((acc, num) =>{return acc + num.population;}, 0);
